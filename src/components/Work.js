    ...
    <div className='container h-auto mx-auto'>
      <div className='flex flex-col lg:flex-row'>
        ...
        className='flex-1 flex flex-col gap-y-20 mb-10 lg:mb-0'>
          ...
          <div onClick={ () => {    window.location.href = 'https://mytinerary-l2gz.onrender.com/'}} className='group relative overflow-hidden border-2 border-white/50 rounded-x1 max-w-md'>
           
            <img  className='group-hover:scale-125 transition-all duration-500 max-w-md' src={Img1} alt='imagen1'/>
          ...
          <div onClick={ () => {window.location.href = 'https://mrwines.onrender.com/'}}className='group relative overflow-hidden border-2 border-white/50 rounded-x1 max-w-md'>
            <div className='group-hover"bg-black/70 w-full h-full absolute z-40 transition-all duration-300' >
            </div>
            <img className='group-hover:scale-125 transition-all duration-500 max-w-md' src={Img3} alt='imagen1'/>
            <div className='absolute -bottom-full left-12 group-hover:bottom-24 transition-all duration-500 z-50'><span className='text-gradient'>Full Stack</span></div>
            <div  className='absolute -bottom-full left-12 group-hover:bottom-14 transition-all duration-700 z-50'>
          ...
          <div onClick={ () => {window.location.href = 'https://gpt-3v.netlify.app/'}}className='group relative overflow-hidden border-2 border-white/50 rounded-x1 max-w-md'>
            <div className='group-hover"bg-black/70 w-full h-full absolute z-40 transition-all duration-300' >
            </div>
            <img className='group-hover:scale-125 transition-all duration-500 max-w-md' src={Img2} alt='imagen1'/>
